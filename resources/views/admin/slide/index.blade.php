    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-{{ config('platform.content-size') }}">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                                href="{{ route('admin.slide') }}">اسلایدها</a></li>
                </ol>
            </nav>
            <div id="accordion">
                <div class="card card-info mb-2">
                    ...
                    <div id="collapseOne" data-parent="#accordion" class="card-body collapse" style="">
                        <form method="GET" action="{{ route('admin.slide') }}">
            ...
            <div class="card card-default">
                <div class="card-header">اسلایدها
                    <a href="{{route('admin.slide.create')}}" class="btn btn-primary btn-sm pull-left"><i
                                class="fa fa-plus-circle"></i> ایجاد اسلاید جدید</a>
                </div>

                <div class="card-body">
                    @include('global.top-table-options',['route' => 'admin.slide.export'])
                                ...
                                <tr>
                                    ...
                                    <td scope="row" class="align-middle">
                                        <a href="{{ route('admin.slide.edit', ['id' => $slide->id]) }}"
                                           ...
                                           data-toggle="tooltip" data-placement="top" title="ویرایش اسلاید"><i
                                        ...
                                        <form method="post" class="d-inline"
                                            ...
                                            <button onclick="return confirm('آیا از عملیات حذف اطمینان دارید؟')"
                                                    ...
                                                    data-toggle="tooltip" data-placement="top" title="حذف اسلاید"><i
                    ...
                    @endif
                    @include('global.pagination',['items' => $slides])
                </div>
            </div>
        </div>
    </div>

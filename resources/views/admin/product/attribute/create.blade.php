        ...
        <div class="col-md-{{ config('platform.content-size') }}">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.product.attribute',[$product->id]) }}">مشخصه های {{$product->title}}</a></li>
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.product.attribute.insert',['id' => $product->id]) }}" onsubmit="$('.price').unmask();"

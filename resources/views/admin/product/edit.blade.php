    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-{{ config('platform.content-size') }}">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.product.update', [$product->id]) }}" onsubmit="$('.price').unmask();"
                        ...
                        <div class="form-group">
                            ...
                            <input dir="ltr" id="initial_balance" type="text"
                                   ...
                                   name="initial_balance" value="{{ old('initial_balance', $product->initial_balance) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2 ml-sm-2">
                                <input id="period_price" type="tel" dir="ltr"
                                       ...
                                       name="period_price" value="{{ old('period_price', \App\Utils\MoneyUtil::display($product->period_price)) }}">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">{{ trans('currency.'.config('platform.currency')) }}</div>
                                </div>
                            </div>
